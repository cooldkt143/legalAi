    ...
    <div className="w-full min-h-screen p-6 bg-background">
      ...
      <div className="relative mb-6 w-full">
        ...
        <Input
          ...
          className="w-full pl-12 h-12 bg-black/20 dark:bg-black/40 backdrop-blur-lg border-white/20 dark:border-white/10 text-white placeholder:text-blue-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
        />
      </div>
